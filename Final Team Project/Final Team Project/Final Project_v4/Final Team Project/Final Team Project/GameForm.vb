...
Public Class GameForm
    ...
    Dim readingFile As StreamReader
    ...
    Private Sub GameForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        My.Computer.Audio.Play("F:\Final Project_v3\Final Team Project\Undertale OST 021 - Dogsong.wav", AudioPlayMode.BackgroundLoop)
    End Sub
End Class